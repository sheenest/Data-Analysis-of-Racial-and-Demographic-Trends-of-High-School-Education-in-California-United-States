...
This project is part of the course, **Introduction to Data Journalism (J124)** at the **University of California, Berkeley, Summer Sessions**. I would like to express my thanks to the Course Instructor, Professor Dana Amihere for all the guidance on this project. 
